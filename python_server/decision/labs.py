...
SNIPE_LANES: tuple[SnipeLane, ...] = (
    SnipeLane(
        id="snipe_tight",
        label="Tight tape",
        thesis="4 buyers, 12% lift, 10 SOL in the curve — skip empty pumps",
        min_buyers=4,
        min_lift_pct=12.0,
        fast_lift_pct=25.0,
        min_real_sol=10.0,
    ...
    SnipeLane(
        id="snipe_wide",
        label="Wide spray",
        thesis="2 buyers / 5% lift — the overnight bleed, kept as a control",
        min_buyers=2,
        min_lift_pct=5.0,
        fast_lift_pct=12.0,
        min_real_sol=2.5,
    ...
    SnipeLane(
        id="snipe_rip",
        label="Let runners run",
        thesis="Tight entry, 40% rip / trail, slower scratch — don't clip at $1",
        min_buyers=4,
        min_lift_pct=12.0,
        fast_lift_pct=25.0,
        min_real_sol=10.0,
    ...
    SnipeLane(
        id="snipe_dollar",
        label="Bank the dollar",
        thesis="Tight entry, clip at $1 — same tape as rip, different exit",
        min_buyers=4,
        min_lift_pct=12.0,
        fast_lift_pct=25.0,
        min_real_sol=10.0,
